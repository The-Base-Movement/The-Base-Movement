-- Migration: Enrich device activity logging and Discord alerts with browser/OS details
-- 
-- 1. Update evaluate_admin_device to log browser and os_type to metadata JSONB
-- 2. Update discord_leader_device_activity to extract and show Browser / OS in the Discord embeds
...
-- Update trigger function to display browser and OS type

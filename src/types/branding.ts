...
export const defaultSettings: BrandingSettings = {
  ...
  registration_form_ghana_url: '/registration-form-preview?platform=GHANA',
  registration_form_diaspora_url: '/registration-form-preview?platform=DIASPORA',
  primary_email: 'info@thebasemovement.org.gh',
  newsletter_email: 'info@thebasemovement.org.gh',
  primary_phone: '+233 55 123 4567',
  primary_address: 'GI-208-9132, 0kn042 Tesano / Abeka 208, Accra, Greater Accra, Ghana',
  primary_address_url: 'https://maps.google.com/?q=GI-208-9132+Tesano+Accra+Ghana',
  font_scale_global: 1.0,
  font_scale_headings: 1.0,
  muted_foreground_color: '131 5% 40%',
  on_surface_muted_color: '131 5% 40%',

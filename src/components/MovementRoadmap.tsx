        ...
        setMilestones([
          {
            ...
            description:
              'Initialization of the member database and official portal activation for all sixteen regions.',
          ...
          },
          {
            ...
            description:
              'A collaborative gathering of grassroots leaders to finalize our economic and civic blueprints.',
          ...
          },
          {
            ...
            description:
              'Onboarding and supporting 100,000 certified community organizers for local engagement.',
  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-on-surface flex items-center gap-3 m-0">
            <span className="p-2 bg-[var(--brand-red)]/10 rounded-none">
              <span
                className="material-symbols-outlined text-[var(--brand-red)]"
                style={{ fontSize: 24 }}
              >
                flag
              </span>
          ...
          <p className="text-xs font-medium text-on-surface/40 mt-3 ml-12">
        ...
        <div className="flex items-center gap-4 ml-12 md:ml-0">
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ backgroundColor: 'rgb(var(--brand-green-rgb))' }}
            />
            <span
              className="text-micro font-medium tracking-tight"
              style={{ color: 'rgb(var(--brand-green-rgb))' }}
            >
              Completed
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div
              className="w-2 h-2 rounded-full"
              style={{ backgroundColor: 'rgb(var(--brand-gold-rgb))' }}
            />
            <span
              className="text-micro font-medium tracking-tight"
              style={{ color: 'rgb(var(--brand-gold-rgb))' }}
            >
              Active
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div
              className="w-2 h-2 rounded-full"
              style={{ backgroundColor: 'rgb(var(--brand-red-rgb))' }}
            />
            <span
              className="text-micro font-medium tracking-tight"
              style={{ color: 'rgb(var(--brand-red-rgb))' }}
            >
              Future
            </span>
          </div>
                ...
                <div
                  className={cn(
                    ...
                    milestone.status === 'In Progress' &&
                      'animate-pulse shadow-[0_0_40px_rgba(var(--brand-gold-rgb),0.6)]'
                  )}
                  style={{
                    backgroundColor:
                      index === 0
              ...
              >
                <div className="bg-white p-8 border-t-[5px] border-t-transparent relative shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span
                        className="px-3 py-1 text-tiny font-medium text-white rounded-sm"
                        style={{
                          backgroundColor:
                            milestone.status === 'Completed'
                              ? 'rgb(var(--brand-green-rgb))'
                      ...
                      <span className="text-tiny font-medium text-on-surface/20 tracking-tight capitalize">
                        {milestone.category}
                      </span>
                    </div>
                  ...
                  <div
                    className={cn(
                      'flex flex-wrap items-center gap-4 pt-6 border-t border-stone-50 text-tiny font-medium text-on-surface/30 tracking-tight',
                    ...
                    {milestone.forecasted_date && (
                      <>
                        ...
                        <div className="flex items-center gap-2 text-[var(--brand-green)] bg-[var(--brand-green)]/5 px-2 py-1">
                          ...
                          <span>
                            Fulfillment:{' '}
                            {new Date(milestone.forecasted_date).toLocaleDateString([], {
                              month: 'short',
                              day: 'numeric',
                              year: 'numeric',
                            })}

...
export const buttonVariants = cva(
    "relative group border text-center transition-all duration-200 inline-flex items-center justify-center gap-2 whitespace-nowrap",
    {
        variants: {
            variant: {
                default: "bg-[hsl(var(--inactive-tab-bg))] text-[hsl(var(--inactive-tab-text))] border-[hsl(var(--primary))]/20 hover:bg-[hsl(var(--inactive-tab-hover))] hover:border-[hsl(var(--primary))]/40 transition-all tracking-tight",
                solid: "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] hover:bg-transparent hover:text-[hsl(var(--primary))] border border-[hsl(var(--primary))] transition-all duration-200 tracking-tight shadow-lg shadow-[hsl(var(--primary))]/20",
                primary: "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] hover:bg-transparent hover:text-[hsl(var(--primary))] border-[hsl(var(--primary))] shadow-[0_0_15px_rgba(var(--brand-green-rgb),0.3)] tracking-tight",
                ...
                "active-tab": "bg-[hsl(var(--active-tab-bg))] text-white border-[hsl(var(--active-tab-bg))] hover:bg-transparent hover:text-[hsl(var(--active-tab-bg))] tracking-tight",

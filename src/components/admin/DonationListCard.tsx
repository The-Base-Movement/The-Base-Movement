  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ width: 38, height: 38, borderRadius: '50%', background: 'rgba(0,107,63,.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'hsl(var(--primary))', fontWeight: 800, fontSize: 13, flexShrink: 0, border: '1px solid rgba(0,107,63,.15)', fontFamily: "'Public Sans', sans-serif" }}>
        ...
        <div style={{ textAlign: 'right', flexShrink: 0 }}>
          <div style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 15, fontVariantNumeric: 'tabular-nums', lineHeight: 1 }}>
            ₵{parseFloat(donation.amount).toLocaleString()}
          </div>
          <div style={{ marginTop: 4 }}>
            <span className={sp.cls} style={{ fontSize: 9 }}>{sp.label}</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 7 }}>
        <span style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontVariantNumeric: 'tabular-nums', fontSize: 11, color: 'hsl(var(--on-surface-muted))', letterSpacing: '.03em' }}>
          {donation.reference.toUpperCase()}
        </span>
        <span style={{ fontSize: 11, fontVariantNumeric: 'tabular-nums', color: 'hsl(var(--on-surface-muted))', fontFamily: "'Public Sans', sans-serif", fontWeight: 700 }}>

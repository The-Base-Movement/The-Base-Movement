  ...
  const kpis = [
    {
      ...
      value: `${pulse.nationalGrowth}%`,
      change: `+${pulse.nationalGrowth}%`,
      trend: 'up',
      icon: 'trending_up',
    },
    {
    ...
    {
      label: 'Top Region',
      value: pulse.topPerformingRegion,
      change: 'Peak',
      trend: 'up',
      icon: 'star',
    },
    ...
    <div className="panel">
      <div className="ph">
        <div>
          ...
          <div className="meta">
            Real-time mobilization telemetry · Updated {new Date().toLocaleDateString()}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {kpis.map((stat) => (
            <div
              key={stat.label}
              className="panel"
              style={{ padding: '16px', background: 'hsl(var(--container-low))' }}
            >
              <div
                style={{
                  display: 'flex',
              ...
              <div key={region.name}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    />
                    <span
                      style={{ fontSize: '11px', fontWeight: 700, color: 'hsl(var(--on-surface))' }}
                    >
                      {region.name}
                    </span>
                  </div>
                  <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <span
                      style={{ fontSize: '10px', fontWeight: 700, color: 'hsl(var(--primary))' }}
                    >
                ...
                >
                  <div
                    style={{
                      ...
                      background:
                        region.activity > 90 ? 'hsl(var(--destructive))' : 'hsl(var(--primary))',

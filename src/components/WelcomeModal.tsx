  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          onClick={onClose}
          className="absolute top-6 right-6 w-8 h-8 rounded-none bg-stone-50 border border-stone-100 flex items-center justify-center text-stone-400 hover:text-brand-green transition-colors z-10"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="p-10">
          ...
          {/* Assignment Card */}
          <div className="border-2 border-brand-green bg-emerald-50/30 p-6 mb-8 relative group">
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 bg-brand-green text-white flex items-center justify-center rounded-none shadow-lg">
          ...
          <div className="space-y-4">
            <Button 
              onClick={onClose}
              className="w-full h-14 bg-brand-green text-white hover:bg-emerald-800 rounded-none font-bold text-sm uppercase tracking-[0.2em] shadow-xl shadow-brand-green/20 transition-all active:scale-95 flex items-center justify-center gap-3"
            >
            ...
            <button 
              ...
              className="w-full py-4 text-xs font-bold text-stone-400 hover:text-brand-green uppercase tracking-widest transition-colors flex items-center justify-center gap-2 group"
            >

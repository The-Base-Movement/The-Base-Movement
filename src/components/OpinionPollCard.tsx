...
export function OpinionPollCard({
  ...
  return (
    <div
      className="bg-white rounded-[6px] overflow-hidden relative"
      style={{
    ...
    >
      <div className="p-[22px]">
          ...
          {poll.options.map((option) => {
            ...
            return (
              <div key={option.id} className="relative">
                {displayResults ? (
                  <div
                    className={`relative px-[14px] py-[10px] rounded-[4px] overflow-hidden transition-all duration-150 ${
                      isLead ? 'ring-1 ring-[var(--primary)]' : ''
                    } bg-[var(--container-low,#f9fafb)]`}
                    style={
                      !isLead ? { boxShadow: 'inset 0 0 0 1px hsl(var(--border))' } : undefined
                    }
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left px-[14px] py-[10px] rounded-[4px] bg-[var(--container-low,#f9fafb)] transition-all duration-150 group/btn hover:ring-1 hover:ring-[var(--primary)]"
        ...
        {/* Footer */}
        <div
          className="mt-[14px] pt-[14px] flex justify-between items-center"

...
export function PublicFeaturedPost({ post, baseUrl }: PublicFeaturedPostProps) {
  ...
  return (
    <section className="mb-16">
      ...
      <div
        className="shadow-sm overflow-hidden group hover:shadow-lg transition-shadow"
        style={{ background: 'hsl(var(--card))', border: '1px solid hsl(var(--border))' }}
      >
        {/* Header: image | category/date + title */}
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="p-6 md:p-10 flex flex-col justify-center">
            ...
            <Link to={`${baseUrl}/${post.slug}`}>
              <h2
                className="text-xl md:text-2xl font-medium tracking-tight leading-tight transition-colors"
        ...
        {/* Body: excerpt + author/read-link, full width */}
        <div className="p-6 md:p-10 md:pt-0">

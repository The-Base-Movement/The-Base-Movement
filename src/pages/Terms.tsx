      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-[var(--brand-red)]/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <FileText className="w-6 h-6 text-[var(--brand-red)]" />
          </div>
          <h1 className="text-3xl font-bold text-[var(--brand-black)] mb-2">Terms of Service</h1>
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="w-10 h-10 bg-[var(--brand-red)]/10 rounded-full flex items-center justify-center shrink-0">
              <Scale className="w-5 h-5 text-[var(--brand-red)]" />
            </div>
            <div>
              <h2 className="font-semibold text-[var(--brand-black)] mb-2">Membership Agreement</h2>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-[var(--brand-black)] mb-2">Code of Conduct</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-[var(--brand-black)] mb-2">Platform Usage</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-6">
            <h3 className="font-semibold text-[var(--brand-black)] mb-3">Commitments</h3>

...
export function SystemPreferencesTab({ interfaceDensity, setInterfaceDensity, toast }: SystemPreferencesTabProps) {
  return (
    <div className="panel">
      <div className="ph">
        <span>Preferences</span>
        <span style={{ fontWeight: 700, color: 'hsl(var(--on-surface-muted))' }}>Configure your personal interface and notification behavior.</span>
      </div>
      <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 24 }}>

        {/* Density */}
        <div>
          <p style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 11, color: 'hsl(var(--on-surface-muted))', marginBottom: 12, marginTop: 0 }}>Interface density</p>
        ...
        {/* Notifications */}
        <div>
          <p style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 11, color: 'hsl(var(--on-surface-muted))', marginBottom: 12, marginTop: 0 }}>Notifications</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              ...
              <div key={item.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px', borderRadius: 4, border: '1px solid hsl(var(--border))', background: 'hsl(var(--container-low))' }}>
                <div>

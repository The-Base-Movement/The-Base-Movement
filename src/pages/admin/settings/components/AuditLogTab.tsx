  ...
  return (
    <div className="panel">
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, padding: '12px 20px', borderBottom: '1px solid hsl(var(--border))', background: 'hsl(var(--container-low))' }}>
        ...
        <select value={auditFilter} onChange={e => setAuditFilter(e.target.value)} style={selSt}>
          <option>All Status</option>
          <option>Success</option>
          <option>Warning</option>
          <option>Failure</option>
        </select>
        <select value={auditResourceFilter} onChange={e => setAuditResourceFilter(e.target.value)} style={selSt}>

        ...
        <>
                ...
                {auditLogs.map((log) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 14px' }}>
                      <span className={actionPill(log.action)} style={{ fontSize: 9.5 }}>
          ...
          <div className="mobile-only">
            {auditLogs.map((log) => (
              <div
                key={log.id}
                style={{ padding: '13px 16px', borderBottom: '1px solid hsl(var(--border))' }}
              >
                ...
                >
                  ...
                  <span className={actionPill(log.action)} style={{ fontSize: 9.5, flexShrink: 0 }}>
                    {log.action.replace(/_/g, ' ')}
                  </span>
                </div>

    ...
    <div className="admin-page-container animate-in fade-in duration-700">
      ...
      <div className="flex-columns items-center" style={{ '--column-gap': '2rem' } as React.CSSProperties}>
        <div className="flow" style={{ '--flow-space': '0.5rem' } as React.CSSProperties}>
          ...
          <BrandLine />
          <p className="text-muted-foreground/80 text-sm mb-0 prose-standard">Real-time intelligence, rapid response dispatch, and threat neutralization.</p>
        </div>
      </div>
              ...
              <div className="divide-y divide-border/40 max-h-[800px] overflow-y-auto">
                {directives.length === 0 ? (
                  ...
                  directives.map((dir) => (
                    ...
                    )} style={{ '--flow-space': '0.5rem' } as React.CSSProperties}>
                      <div className="flex justify-between items-start gap-4">
                        <span className={cn(

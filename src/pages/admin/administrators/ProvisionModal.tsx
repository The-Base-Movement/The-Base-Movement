...
interface ProvisionModalProps {
  ...
  needsLoginEmail: boolean
  provisionEmail: string
  setProvisionEmail: (e: string) => void
}
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Admin login email — required for phone-registered members */}
          {selectedMember && needsLoginEmail && (
            <div>
              <label htmlFor="provision-email" style={labelSt}>
                Admin login email <span style={{ color: 'hsl(var(--destructive))' }}>*</span>
              </label>
              <input
                id="provision-email"
                name="provisionEmail"
        ...
        >
          ...
          <button
            ...
            style={{ flex: 1 }}
            disabled={
              !selectedMember || isProvisioning || (needsLoginEmail && !provisionEmail.trim())
            }

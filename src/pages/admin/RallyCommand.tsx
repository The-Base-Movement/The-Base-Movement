    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[10px] font-bold normal-case text-primary">Initializing mobilization command...</p>
        </div>
      </div>
    )
  }
                ...
                {actions.map((action) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-[9px] font-bold text-muted-foreground/80">{format(new Date(action.start_time), 'MMM dd, HH:mm')}</span>
                    </div>
                    <h3 className="text-[11px] font-bold normal-case tracking-tight text-on-surface leading-tight">{action.title}</h3>
                    <div className="flex items-center gap-2 mt-2">
                      <MapPin className="w-3 h-3 text-muted-foreground/40" />
                      <p className="text-[9px] font-bold text-muted-foreground/80 normal-case truncate">{action.location_name}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left">
                      ...
                      <tbody className="divide-y divide-border/40">
                        {attendance.length === 0 ? (
                          <tr>
                            <td colSpan={4} className="px-6 py-12 text-center text-[10px] font-bold text-muted-foreground/80 normal-case">No signals detected for this action</td>
                          </tr>
                        ) : (
              ...
              <Card className="rounded-sm border-border/40 shadow-sm bg-background overflow-hidden">
                <div className="bg-on-surface px-6 py-4 flex items-center justify-between border-b border-white/5">
                  ...
                  <span className="text-[9px] font-bold text-white/40 normal-case">{selectedAction.geofence_radius_meters}m radius</span>
                </div>
                <div className="h-64 bg-muted/10 flex items-center justify-center relative group">
                  ...
                  <div className="relative text-center">
                    ...
                    <p className="text-[10px] font-bold normal-case text-muted-foreground/80">Satellite engagement visualization</p>
                    <p className="text-[9px] font-bold text-on-surface mt-2 normal-case">{selectedAction.location_name}</p>
                  </div>

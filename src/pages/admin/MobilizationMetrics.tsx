    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" className="rounded-xl border-border/60 text-on-surface/80 text-[10px] px-6 font-bold hover:bg-muted/30 shadow-sm h-10">
            <Filter className="w-3.5 h-3.5 mr-2" /> Filter data
          </Button>
          <Button className="rounded-xl bg-on-surface text-white text-[10px] px-6 font-bold hover:bg-on-surface/90 shadow-sm h-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          <Card key={i} className="rounded-xl border-border/60 shadow-sm bg-white p-6 flex flex-col justify-between hover:border-on-surface/40 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* 🥇 Primary Leaderboard */}
        <Card className="lg:col-span-2 rounded-xl border-border/60 shadow-sm bg-background overflow-hidden">
              ...
              {loading ? (
                Array(3).fill(0).map((_, i) => (
                  <div key={i} className="p-6 animate-pulse space-y-4">
                    ...
                    <div className="h-12 bg-muted/20 w-full rounded-xl" />
                  </div>
                ))
              ) : leaderboard.length === 0 ? (
        ...
        <div className="space-y-8">
          ...
          {/* ⚡ Movement Pulse */}
          <Card className="rounded-xl border-border/60 shadow-sm bg-background p-8 space-y-6">

  ...
  return (
    <div className="settings-form-grid" style={{ alignItems: 'stretch' }}>
      ...
      <div style={{ background: 'hsl(var(--on-surface))', borderRadius: 6, padding: 28, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 14 }}>
        <h4 style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 15, color: '#fff', margin: 0 }}>
          Maximize engagement
        </h4>
        ...
        <span className="material-symbols-outlined" style={{ position: 'absolute', bottom: -10, right: -10, fontSize: 110, color: 'rgba(255,255,255,0.04)', transform: 'rotate(12deg)', pointerEvents: 'none' }}>
          bar_chart
        </span>
      </div>

    ...
    <div className="kpis">
      {kpis.map((kpi) => (
        ...
        >
          ...
          {/* Label */}
          <p style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 10, color: 'hsl(var(--on-surface-muted))', textTransform: 'uppercase', letterSpacing: '0.07em', margin: '0 0 6px' }}>
            {kpi.label}
          </p>

          {/* Main value */}
          <p style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 'var(--kpi-num-size)', color: 'hsl(var(--on-surface))', margin: '0 0 4px', lineHeight: 1.1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {kpi.value}
          </p>

          {/* Sub-label */}
          <p style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 700, fontSize: 11, color: 'hsl(var(--on-surface-muted))', margin: 0 }}>
            {kpi.sub}
          </p>
        </div>
      ))}

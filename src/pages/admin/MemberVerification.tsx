          ...
          <div className="ph" style={{ gap: 8, flexWrap: 'wrap' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <select
                ...
                value={statusFilter}
                onChange={(e) =>
                  handleFilter(e.target.value as PendingVerification['status'] | 'All')
                }
                style={{
                  height: 36,
                  paddingLeft: 30,
        ...
        {selectedMember ? (
          ...
          >
              ...
              <div style={{ background: '#fff', padding: '18px 22px' }}>
                ...
                {(selectedMember.emergencyName || selectedMember.emergencyPhone) && (
                  ...
                  >
                    ...
                    <dl
                      style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px 18px' }}
                    >
                      {[
            ...
            <div className="panel">
              ...
              <div
                style={{ padding: '14px 22px', display: 'flex', flexDirection: 'column', gap: 8 }}
              >
                {[
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                >
                  ...
                  >
                    This record is persistently stored in the movement's secure audit vault.
                    Metadata cannot be altered after verification completion.
                  </p>
                </div>
              </div>
            </div>

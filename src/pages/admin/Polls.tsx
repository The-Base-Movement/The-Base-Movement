    ...
    <div className="main" style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div className="panel desktop-only">
        <div className="ph">
          ...
          >
            ...
            {!isLoading && (
              <span className="meta">
                {filteredPolls.length} record{filteredPolls.length !== 1 ? 's' : ''}
              </span>
            )}
          </span>
        ...
        {isLoading ? (
          Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              ...
              />
              <div
                style={{ height: 34, background: 'hsl(var(--container-low))', borderRadius: 4 }}
              />
            </div>
          ))
        ) : filteredPolls.length === 0 ? (
      ...
      <div className="settings-form-grid" style={{ alignItems: 'stretch' }}>
        ...
        >
          ...
          >
            Use regional-specific polls to gather more precise data. Our research shows chapters
            with localized campaigns see 40% higher member participation.
          </p>
          <button
            className="btn btn-sm"
            style={{
                ...
                <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        { icon: 'location_on', label: 'Region', value: viewPoll.region },
                        {
                          ...
                          label:
                            viewPoll.status === 'Active'
                              ...
                              : 'End date',
                          value: viewPoll.endDate,
                        },
                        {
                          icon: 'group',
                          label: 'Total votes',
                          value: viewPoll.totalVotes.toLocaleString(),
                        },
                      ].map((m) => (
                        <div
                          key={m.label}
                  ...
                  >
                    ...
                    {sorted.map((option, rank) => {
                      const pct =
                        viewPoll.totalVotes > 0
                          ? Math.round((option.votes / viewPoll.totalVotes) * 100)
                          : 0
                  ...
                  >
                    ...
                    >
                      {viewPoll.totalVotes.toLocaleString()} votes
                    </span>
                  </div>
                </div>

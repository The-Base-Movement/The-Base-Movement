  ...
  const templates = [
    {
      ...
      priority: 'High',
      content:
        'All chapters are invited to initiate regional registration drives this weekend. Goal: 10,000 new verified members.',
    },
    {
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 10 }}>
                      <span style={{ ...pillBase, ...priorityStyle(b.priority) }}>
                        {b.priority}
                      </span>
                      <span
                        style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                Urgent mobilization triggers immediate notifications to all connected field assets.
                Use only for critical broadcasts.
              </p>
              <button
                className="btn btn-dest"
                style={{ width: '100%' }}
                onClick={() =>
                  navigate('/admin/broadcasts/new', { state: { template: templates[2] } })
                }
              >
                <span className="material-symbols-outlined" style={{ fontSize: 15 }}>
                  error

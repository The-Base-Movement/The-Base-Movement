    ...
    <div className="main">
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    · since {selectedMember.joined?.split('-')[0] || '2025'}
                  </div>
                  <h2
                    style={{
                      fontFamily: "'Public Sans', sans-serif",
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => toast.error(`Flagging ${selectedMember.name}…`)}
                  >
                    <span className="material-symbols-outlined" style={{ fontSize: 14 }}>
                      flag
                    </span>
              ...
              <div className="member-quick-stats">
                {[
                  ...
                  {
                    label: 'Polls voted',
                    val: memberPollVotes.length || '—',
                    sub: 'Poll activity',
                  },
                  { label: 'Chapter activity', val: '—', sub: 'Events attended YTD' },
                  {
                    label: 'Membership tier',
                    val: selectedMember.type || 'Citizen',
                    sub: 'Active tier',
                    accent: true,
                  },
                ].map((s, i) => (
                      ...
                      <div>
                        <div className="panel" style={{ marginBottom: 20 }}>
                          ...
                          <div style={{ padding: '18px 24px' }}>
                            {detailLogs.length > 0
                              ? detailLogs.slice(0, 8).map((log, i, arr) => {
                              ...
                              : [
                                  {
                                    ...
                                    time: selectedMember.joined || 'On join',
                                  },
                                  {
                                    icon: 'verified',
                                    text: 'Status set to ' + (selectedMember.status || 'Pending'),
                                    time: 'On registration',
                                  },
                                  {
                                    icon: 'place',
                                    text: 'Region assigned: ' + (selectedMember.region || '—'),
                                    time: 'Auto',
                                  },
                                ].map((e, i, arr) => (
                                  <div
                        ...
                        <div className="panel">
                          ...
                          <div style={{ padding: '18px 24px' }}>
                            ...
                            >
                              ...
                              >
                                lifetime · {memberDonations.length} donations
                              </div>
                            </div>
                            <div
                              style={{
                      ...
                      <div>
                        ...
                        <div className="panel" style={{ marginBottom: 20 }}>
                          ...
                          <div style={{ padding: '18px 24px' }}>
                            {[
                              {
                                ok: !!selectedMember.phone,
                                label: 'Phone number on file',
                                detail: selectedMember.phone ? 'verified' : 'missing',
                              },
                              {
                                ok: !!selectedMember.email,
                                label: 'Email address registered',
                                detail: selectedMember.email ? 'on file' : 'missing',
                              },
                              {
                                ok:
                                  selectedMember.status === 'Active' ||
                                ...
                                detail: selectedMember.status,
                              },
                              {
                                ok: !!selectedMember.region,
                                label: 'Region assigned',
                                detail: selectedMember.region || 'unassigned',
                              },
                              ...
                              <div
                                ...
                                style={{
                                  ...
                                  padding: '8px 0',
                                  borderBottom:
                                    i < arr.length - 1 ? '1px solid hsl(var(--border))' : 'none',
                                  fontSize: 12,
                                }}
                              >
                                <div
                        ...
                        <div className="panel">
                          ...
                          <div style={{ padding: '14px 24px' }}>
                            {memberNotes.length > 0 ? (
                              memberNotes.slice(0, 3).map((n, i, arr) => (
                                <div
                                  key={n.id}
                                  style={{
                                    padding: '10px 0',
                              ...
                              <>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {selectedMember.platform === 'DIASPORA'
                                      ? 'diaspora portal'
                          ...
                          {selectedMember.status === 'Pending' && (
                            <>
                              <button
                                ...
                                onClick={() => handleVerify(selectedMember.id, selectedMember.name)}
                              >
                                <span
                                  className="material-symbols-outlined"
                                  style={{ fontSize: 16 }}
                ...
                <div>
                    ...
                    <div style={{ padding: 18 }}>
                      ...
                      >
                        ...
                        >
                          ...
                          {memberDonations.reduce((s, d) => s + d.amount, 0).toLocaleString() ||
                            '0'}
                        </div>
                        <div
                          style={{
                        ...
                        >
                          lifetime · {memberDonations.length} donation
                          {memberDonations.length !== 1 ? 's' : ''}
                        </div>
                      </div>
                      <div
                        style={{
                  ...
                  <div className="panel">
                    <div className="ph2">
                      ...
                      <span className="meta">{memberDonations.length} records</span>
                    </div>
                    {memberDonations.length === 0 ? (
                      ...
                      <div style={{ padding: '14px 24px' }}>
                        ...
                        >
                          ...
                          {selectedMember.platform === 'DIASPORA'
                            ? 'diaspora portal'
                            : 'standard registration'}
                          . Status set to {selectedMember.status}.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div style={{ maxWidth: 520, margin: '0 auto' }}>
                  ...
                  >
                    <button
                      ...
                      title={
                        !selectedMember.avatarUrl
                          ? 'Member has no profile photo — card cannot be printed'
                          : undefined
                      }
                      style={{
                        opacity: selectedMember.avatarUrl ? 1 : 0.4,
                        cursor: selectedMember.avatarUrl ? 'pointer' : 'not-allowed',
                      }}
                    >
                      <span className="material-symbols-outlined" style={{ fontSize: 16 }}>
                        print
      ...
      {isAuditModalOpen && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setIsAuditModalOpen(false)
          }}
        >
          <div
            style={{
          ...
          >
            ...
            >
              <button className="btn btn-outline" onClick={() => setIsAuditModalOpen(false)}>
                Close history
              </button>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setAssignmentData({ ...assignmentData, chapterId: e.target.value })
                  }
                  style={{
                    width: '100%',
                    height: 44,
              ...
              >
                ...
                >
                  This appointment will be logged in the permanent audit trail. Appointed leaders
                  gain administrative oversight for their specific chapter.
                </p>
              </div>
            </div>
            <div
      ...
      {isDeleteModalOpen && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget && !isDeletingMembers) setIsDeleteModalOpen(false)
          }}
        >
          <div
            style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  These records will be <strong>permanently erased</strong> from the movement
                  database. Authentication credentials, activity history, and all associated data
                  will be destroyed. This action <strong>cannot be undone</strong>.
                </p>
              </div>
            </div>

...
<a href="https://www.thebasemovement.org.gh" style="display:inline-block;background:#CE1126;color:#fff;padding:14px 28px;border-radius:4px;font-family:'Public Sans',Arial;font-weight:800;font-size:14px;text-decoration:none;margin:8px 0 20px">RSVP Now →</a>`,
  },
  {
    id: 'member-update',
    label: 'Member Update',
...
<a href="https://www.thebasemovement.org.gh/dashboard" style="display:inline-block;background:#006B3F;color:#fff;padding:14px 28px;border-radius:4px;font-family:'Public Sans',Arial;font-weight:800;font-size:14px;text-decoration:none;margin:8px 0 20px">Go to Dashboard →</a>`,
  },
  {
    id: 'policy',

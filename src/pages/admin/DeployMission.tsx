      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="panel">
            ...
            <div
              style={{ padding: '20px 18px', display: 'flex', flexDirection: 'column', gap: 18 }}
            >
              {/* Mission title */}
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewCampaign({ ...newCampaign, goal_contacts: Number(e.target.value) })
                  }
                  min="1"
                  required
                />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div className="panel" style={{ borderLeft: '3px solid hsl(var(--destructive))' }}>
            <div
              style={{ padding: '14px 18px', display: 'flex', gap: 10, alignItems: 'flex-start' }}
            >
              <span
                className="material-symbols-outlined"
                style={{

            ...
            return (
              ...
              >
                ...
                {selectedDonation.receiptUrl && (
                  <div
                    style={{ padding: '12px 20px', borderBottom: '1px solid hsl(var(--border))' }}
                  >
                    <button
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      handleVerify(selectedDonation.id, selectedDonation.fullName, 'Rejected')
                    }
                    disabled={
                      isVerifying === selectedDonation.id || selectedDonation.status !== 'Pending'
                    }
                  >
                    <span className="material-symbols-outlined" style={{ fontSize: 14 }}>
                      flag
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleVerify(selectedDonation.id, selectedDonation.fullName, 'Verified')
                    }
                    disabled={
                      isVerifying === selectedDonation.id || selectedDonation.status !== 'Pending'
                    }
        ...
        >
          ...
          >
            ...
            >
              <div>
                <div
                  style={{ fontFamily: "'Public Sans', sans-serif", fontWeight: 800, fontSize: 15 }}
                >
                  Transaction receipt
                </div>
                <div

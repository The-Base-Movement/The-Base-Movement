...
export function HeroStats({ totalRaised, totalMembers }: HeroStatsProps) {
  return (
    <div className="bg-on-surface text-white relative overflow-hidden py-12 lowercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-2">
            ...
            <h2 className="text-3xl md:text-4xl font-meta font-bold tracking-tight mb-4">
              total mobilized: <span className="text-primary">ghs {totalRaised.toLocaleString()}</span>
            </h2>

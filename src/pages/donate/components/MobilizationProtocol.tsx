  ...
  return (
    ...
    >
      ...
      <div className="donate-steps" style={{ display: 'grid', gap: 8, marginBottom: 18 }}>
        <style>{`
          .donate-steps { grid-template-columns: repeat(4, 1fr); }
          @media (max-width: 640px) { .donate-steps { grid-template-columns: repeat(2, 1fr); } }
        `}</style>
        {steps.map((step) => (
          <button
            key={step.id}
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 10, flexDirection: 'row' }}>

    ...
    <main className="min-h-screen bg-stone-50/50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 max-w-lg mx-auto">
        <div className="w-24 h-24 bg-white border border-slate-100 shadow-xl flex items-center justify-center mx-auto mb-10 group hover:rotate-6 transition-transform duration-500">
          <span
            className="material-symbols-outlined text-brand-green group-hover:scale-110 transition-transform"
            style={{ fontSize: 40 }}
          >
            search
          </span>
        ...
        <p className="font-meta text-brand-green tracking-tight text-xs font-bold mb-4">
          Error 404
        </p>
        ...
        <p className="text-slate-500 text-sm md:text-base leading-relaxed mb-10 px-4">
          ...
          vault. Let's get you back to the front lines.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/"
            className="h-14 px-10 w-full sm:w-auto bg-primary text-white flex items-center justify-center text-sm gap-2 hover:opacity-90 transition-opacity"
            style={{
          ...
          <Link
            to="/blog"
            className="h-14 px-10 w-full sm:w-auto border border-slate-200 text-slate-700 flex items-center justify-center text-sm gap-2 hover:bg-slate-50 transition-colors"
            style={{
              borderRadius: 'var(--button-radius)',
              fontWeight: 'var(--button-font-weight)',
            }}
      ...
      <div className="mt-20 text-center">
        <p className="text-micro font-bold text-slate-300 tracking-tight mb-0">
          Ghana first • Collective progress
        </p>
      </div>
    </main>
  )

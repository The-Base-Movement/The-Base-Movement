    ...
    <div className="py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-stone-950 mb-2">Privacy Agreement</h1>
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-stone-950 mb-2">Data Protection</h2>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-stone-950 mb-2">Information We Collect</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-stone-950 mb-2">Data Storage</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-6">
            <h3 className="font-semibold text-stone-950 mb-3">Your Rights</h3>
          ...
          <p className="text-sm text-gray-500 text-center pt-4">
            Last updated: April 2026. If you have questions about this privacy agreement, please <a href="/contact" className="text-primary hover:underline">contact us</a>.
          </p>
        </div>
      </div>
    </div>

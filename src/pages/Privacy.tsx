      ...
      <div className="bg-charcoal-dark text-white pt-24 pb-16 border-b-4 border-brand-green relative overflow-hidden">
        ...
        <div className="page-container relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-2xl font-body-md">
            Our commitment to data sovereignty and the absolute protection of our members' digital
            footprint.
          </p>
        </div>
      </div>
          ...
          <div className="flow" style={{ '--flow-space': '3rem' } as React.CSSProperties}>
            <section className="bg-white p-8 md:p-12 border border-slate-200 shadow-sm">
              <div className="flex gap-6">
                ...
                <div>
                  <h2 className="text-xl font-medium text-charcoal-dark mb-4 font-meta tracking-tight">
                    Data protection
                  </h2>
                  <p className="text-slate-600 leading-relaxed text-sm md:text-base prose-standard">
                    The Base is committed to protecting your personal information. We collect only
                    the data necessary for membership administration and movement coordination. All
                    information is stored securely and accessed only by authorized personnel. We
                    believe in data sovereignty and ensure that your information remains within the
                    movement's secure infrastructure.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white p-8 md:p-12 border border-slate-200 shadow-sm">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed text-sm md:text-base prose-standard">
                    We collect your name, contact details, location, and platform preference to
                    connect you with the appropriate chapter and keep you informed about movement
                    activities. This data allows us to provide a tailored experience and ensures
                    that our mobilization efforts are targeted and effective. Optional information
                    helps us understand our membership demographics better.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white p-8 md:p-12 border border-slate-200 shadow-sm">
              <div className="flex gap-6">
                <div className="w-12 h-12 bg-charcoal-dark/10 rounded-none flex items-center justify-center shrink-0">
                  <span
                    className="material-symbols-outlined text-charcoal-dark"
                    style={{ fontSize: 24 }}
                  >
                    dns
                  </span>
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed text-sm md:text-base prose-standard">
                    Your data is stored on secure servers with industrial-grade encryption. We do
                    not sell, rent, or share your personal information with third parties for
                    marketing purposes. Your information is used solely for The Base membership
                    administration, internal communication, and verified movement activities.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-charcoal-dark p-8 md:p-12 border-l-4 border-warm-gold text-white">
              <h3 className="font-meta font-medium text-xl tracking-tight mb-6">

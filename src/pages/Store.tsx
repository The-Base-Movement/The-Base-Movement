...
export default function Store() {
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="inline-flex items-center gap-0 border border-border rounded-[3px] mt-1.5 h-[22px]">
                ...
                <span className="px-2 font-meta font-medium text-[11px]">{item.quantity}</span>
                <button
                  className="w-[22px] h-full flex items-center justify-center hover:bg-stone-50 transition-colors"
                  onClick={() =>
                    updateCartQuantity(
            ...
            <div className="text-right shrink-0">
              <div className="font-meta font-medium text-[13px] mb-1">
  ...
  const CartSummary = () => (
    <div className="font-meta">
      ...
      <div className="flex justify-between py-1 text-[12px] font-medium text-on-surface-muted">
        Shipping <b className="text-on-surface font-medium">₵{shipping}</b>
      </div>
      <div className="flex justify-between py-1 text-[12px] font-medium text-on-surface-muted">
        Member discount <b className="text-primary font-medium">−₵{discount}</b>
      </div>
      <div className="flex justify-between pt-2.5 mt-1.5 border-t border-border">
        <b className="text-lg font-semibold tracking-tight">Total</b>
        <span className="text-lg font-semibold tracking-tight">₵{total.toFixed(0)}</span>
      </div>
    </div>
  )
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border">
              <h3 className="font-meta font-medium text-[15px] m-0 flex items-center gap-2">
                Your cart
                <span className="bg-primary text-white px-2 py-0.5 rounded-full text-[10px] font-medium">
                  {cartCount}
                </span>

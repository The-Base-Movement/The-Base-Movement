...
export default function Home() {
  ...
  // Section scroll animations — every [data-fade] element fades up when entering viewport
  useGSAP(() => {
    ...
    <main className="bg-background font-body-md">
      ...
      >
        {!lowBandwidthMode ? (
          <>
            <img
              src={settings.hero_bg_url || '/hero-bg.png'}
              alt=""
              aria-hidden="true"
        ...
        <div className="max-w-[1280px] mx-auto px-5 sm:px-8 py-14 md:py-[80px] relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-white/90 text-sm md:text-base font-body-md max-w-xl mt-4 mb-6 leading-relaxed">
              ...
              national development. Join citizens in Ghana and across the diaspora working for a
        ...
        <div className="max-w-[1280px] mx-auto px-5 sm:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12" data-fade-stagger>
            ...
            <div className="border-l-2 border-accent pl-6">
              ...
              <p className="text-white/80 leading-relaxed font-body-md text-sm">
                We believe young people must be at the heart of our progress, equipped with the
                skills and opportunities to lead Ghana's development.
              </p>
            </div>
            <div className="border-l-2 border-primary pl-6">
              ...
              <p className="text-white/80 leading-relaxed font-body-md text-sm">
                A movement built on trust. We believe every leader must be answerable to the
                citizens they represent and the promises they make.
              </p>
            </div>
          </div>
        </div>
                            ...
                            <div style={{ padding: '14px 16px' }}>
                              ...
                              >
                                {[
                                  ...
                                  {
                                    v: chapter.status === 'Active' ? 'Open' : 'Closed',
                                    l: 'Status',
                                  },
                                ].map((stat) => (
                                  <div key={stat.l}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      {poll.options.slice(0, 4).map((opt) => {
                        ...
                        const isLead =
                          topOption !== null && opt.id === topOption.id && totalVotes > 0
                        return (
                          <div
                            key={opt.id}
                            style={{
      ...
      <section
        ...
        className="px-5 sm:px-8 pt-16 md:pt-24 pb-16 md:pb-32 bg-white"
          ...
          >
            ...
            <div className="relative z-10 px-6 py-12 sm:px-12 sm:py-16 md:px-24 md:py-24 flex flex-col items-center text-center">
              <div className="max-w-4xl">
                <span className="text-accent font-meta font-bold tracking-tight text-xs mb-4 md:mb-6 block">
                  Ready to build Ghana?
                </span>
                <h2
                  id="cta-heading"
                ...
                <p className="text-base md:text-xl text-white/80 mb-8 md:mb-12 leading-relaxed font-body-md max-w-2xl mx-auto">
                  Be part of a growing movement focused on jobs, accountability, and a stronger

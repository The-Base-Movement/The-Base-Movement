    ...
    <div className="main">
      ...
      {isLeader && (
        ...
        >
          ...
          <Link
            to={`/dashboard/chapter-hub/${chapter.name
              .toLowerCase()
              .replace(/[^a-z0-9]+/g, '-')
              .replace(/(^-|-$)+/g, '')}`}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="panel" style={{ padding: '20px 22px' }}>
            ...
            >
              ...
              connect with fellow movement members, the {chapter.name} provides the platform for
              meaningful civic engagement and collective action within {chapter.city_or_region}.
            </p>
            <div
              style={{
                display: 'grid',
            ...
            >
              ...
              >
                ...
                >
                  {chapter.local_focus || 'Grassroots mobilization'}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  {chapter.meeting_schedule || 'Contact chapter for schedule'}
                </div>
              </div>
            </div>
          </div>
                      ...
                      {isOpen && !myVote ? (
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                          ...
                          {poll.chapter_poll_candidates
                            ...
                            .map((c, i) => {
                              const pct =
                                totalVotes > 0 ? Math.round((c.count / totalVotes) * 100) : 0
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                This chapter is officially recognized and verified by The Base National
                Headquarters. All activities are coordinated with the central movement agenda.
              </p>
              <span
                style={{
                  display: 'inline-flex',
          ...
          <div className="panel" style={{ padding: '20px 22px' }}>
            ...
            >
              Your donations to this specific chapter help fund local townhalls and community
              outreach programs in {chapter.city_or_region}.
            </p>
            <Link
              to="/dashboard/donate"
          ...
          >
            ...
            <div style={{ padding: '36px 24px 24px' }}>
                ...
                {[
                  {
                    ...
                    label: 'Network',
                    value:
                      leaderProfile.platform === 'GHANA' ? 'Ghana Network' : 'Diaspora Network',
                  },
                  {
                    icon: 'location_on',
                    label: 'Location',
                    value:
                      leaderProfile.platform === 'GHANA'
                        ? leaderProfile.region
                        : leaderProfile.country,
                  },
              ...
              >
                ...
                >
                  Appointed chapter leader for {chapter.name}. Responsible for coordinating local
                  chapter activities and driving grassroots mobilization in {chapter.city_or_region}
                  .
                </p>
              </div>

  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
        <span className="material-symbols-outlined animate-spin" style={{ fontSize: 32, color: 'var(--brand-green)' }}>progress_activity</span>
      ...
      <>
        ...
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-6">
          <div className="w-16 h-16 bg-stone-100 flex items-center justify-center mb-8 rotate-3">
            <span className="material-symbols-outlined text-stone-300" style={{ fontSize: 32 }}>search</span>
          </div>
          ...
          <button onClick={() => navigate(baseUrl)} className="h-14 px-10 bg-primary text-white font-bold border-none cursor-pointer flex items-center gap-2 hover:opacity-90 transition-opacity">
            Return to insights
      ...
      <main className="max-w-[1280px] mx-auto px-6 md:px-8 pt-12">
        <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="material-symbols-outlined" style={{ fontSize: 16, marginRight: 8 }}>share</span> Share
            </button>
          ...
          <header className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4 text-stone-400 text-micro font-bold tracking-tight">
                <span className="flex items-center gap-1.5"><span className="material-symbols-outlined" style={{ fontSize: 14 }}>calendar_today</span> {post.publishedAt ? new Date(post.publishedAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' }) : 'N/A'}</span>
                <span className="flex items-center gap-1.5"><span className="material-symbols-outlined" style={{ fontSize: 14 }}>schedule</span> {post.readTime}</span>
              </div>
            </div>
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      { brandColor: '#1877F2', key: 'facebook', icon: (
                      ...
                      { brandColor: '#0A66C2', key: 'linkedin', icon: (
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      { brandColor: '#24A1DE', key: 'telegram', icon: <span className="material-symbols-outlined" style={{ fontSize: 16 }}>send</span> },
                      { brandColor: '#71717a', key: 'email', icon: <span className="material-symbols-outlined" style={{ fontSize: 16 }}>mail</span> }

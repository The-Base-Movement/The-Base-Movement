  ...
  return (
    <div className="bg-white border border-border rounded-[4px] p-6 quick h-full">
      ...
      <style
        ...
        .qa b { display: block; font-family: 'Public Sans', sans-serif; font-size: 12px; font-weight: var(--font-weight-semibold, 600); letter-spacing: -0.005em; color: hsl(var(--on-surface)); line-height: 1.2; margin: 0; }

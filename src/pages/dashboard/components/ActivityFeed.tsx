  ...
  return (
    <div className="flex flex-col">
      <div
        ...
        style={{ maxHeight: 758, overflowY: 'auto', paddingRight: 4 }}
      >
        {loading ? (
      ...
      <style
        ...
        /* Desktop cap (inline maxHeight: 758px) ≈ 13 feed rows before scroll. Mobile caps to viewport. */
        @media (max-width: 768px) { .activities-container { max-height: 60vh !important; } }

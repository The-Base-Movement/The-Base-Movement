    ...
    >
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 9, color: '#64748b', margin: 0 }}>TBM-YW-</p>
          <div style={{ height: 16, borderBottom: '1.5px solid #cbd5e1', marginTop: 2 }} />
        </div>
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          Return completed forms to the nearest Base office. Enrol online instead at
          thebasemovement.org.gh/youth-wing/register
        </p>
      </div>
    </div>
  )

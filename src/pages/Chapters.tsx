    ...
    return (
      <div className="main">
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Proposals are reviewed by the National Executive Committee for strategic
                  alignment.
                </p>
              </div>
              ...
              {submissionSuccess ? (
                <div style={{ padding: 40, textAlign: 'center' }}>
                  ...
                  >
                    Your proposal for <strong>{chapterLocation}</strong> has been logged.
                    Coordinators will contact you shortly.
                  </p>
                </div>
              ) : (
                <form
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            Connect with your local community through our network of {chapters.length} regional
            hubs.
          </p>
        </div>
        ...
        <div className="kpis" style={{ marginBottom: 24 }}>
          {[
            ...
            {
              label: 'Countries',
              value: new Set(chapters.map((c) => c.country)).size,
              sub: 'Global presence',
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
          ...
          <div className="mt-6">
            ...
            <p className="text-stone-500 max-w-2xl mt-6 leading-relaxed font-medium text-sm md:text-base">
              Connect with your local community through our global network of {chapters.length}+
              regional hubs.
            </p>
          </div>
        </div>

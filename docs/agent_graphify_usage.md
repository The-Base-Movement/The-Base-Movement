...
As an AI agent, you should use Graphify to deeply understand the platform's architecture *before* making structural modifications or answering complex system questions.

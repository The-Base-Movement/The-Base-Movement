...
const regionConstituencies = {
  ...
  'Western': ['Ahanta West', 'Amenfi Central', 'Amenfi East', 'Amenfi West', 'Effia', 'Ellembelle', 'Essikado-Ketan', 'Evalue-Ajomoro-Gwira', 'Jomoro', 'Kwesimintsim', 'Mpohor', 'Prestea Huni-Valley', 'Sekondi', 'Shama', 'Takoradi', 'Tarkwa-Nsuaem', 'Wassa East'],
